		...
		$scope.submitForm = function() {
			...
			if ($scope.createForm.$valid) {
				...
				MELI.login(function() {
					...
					var jsonToPost =  {'items': [{'id': '123','title': $scope.description, 'quantity': 1, 'unit_price': $scope.partialAmount, 'currency_id': 'ARS', 'picture_url': 'http://hagamosunavaquita.com.ar/cowww.png'}]};
